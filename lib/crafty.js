        ...
        * });
        ...
        timer: {
            ...
            init: function () {
                ...
                if (onFrame) {
                    ...
                    tick = setInterval(Crafty.timer.step,
                        1000 / FPS);
                }
            },
        ...
        e: function () {
            ...
            if (arguments.length > 0) {
                craft.addComponent.apply(craft,
                    arguments);
            }
        ...
        settings: (function () {
            ...
            return {
                ...
                modify: function (setting, value) {
                    ...
                    callbacks[setting].call(states[setting],
                        value);
                    ...
                    function () {
                        ...
                        for (; i < l; ++i) {
                            ...
                            if (current.obj[current.prop] !== current.obj['_' + current.prop]) {
                                current.fn.call(current.obj,
                                    current.obj[current.prop]);
                            }
                        }
                    });
            }
...
(function (Crafty, window, document) {
    ...
    * }
                ...
                for (var h in this.map) {
                    ...
                    if (i >= hash.max.x) {
                        ...
                        for (k in this.map[h]) {
                            ...
                            if (typeof ent == 'object' && 'requires' in ent) {
                                coords.max.x = Math.max(coords.max.x,
                                    ent.x + ent.w);
                            }
                        }
                    }
                    if (i <= hash.min.x) {
                        ...
                        for (k in this.map[h]) {
                            ent = this.map[h][k];
                            if (typeof ent == 'object' && 'requires' in ent) {
                                coords.min.x = Math.min(coords.min.x,
                                    ent.x);
                            }
                        }
                    }
                    if (j >= hash.max.y) {
                        ...
                        for (k in this.map[h]) {
                            ent = this.map[h][k];
                            if (typeof ent == 'object' && 'requires' in ent) {
                                coords.max.y = Math.max(coords.max.y,
                                    ent.y + ent.h);
                            }
                        }
                    }
                    if (j <= hash.min.y) {
                        ...
                        for (k in this.map[h]) {
                            ent = this.map[h][k];
                            if (typeof ent == 'object' && 'requires' in ent) {
                                coords.min.y = Math.min(coords.min.y,
                                    ent.y);
                            }
                        }
                    }
    ...
    Crafty.c("2D",
        {
            ...
            _rotate: function (v) {
                ...
                var x0 = o.x + (this._x - o.x) * ct + (this._y - o.y) * st,
                    ...
                    minx = Math.floor(Math.min(x0,
                        x1,
                        x2,
                        x3)),
                    miny = Math.floor(Math.min(y0,
                        y1,
                        y2,
                        y3)),
                    maxx = Math.ceil(Math.max(x0,
                        x1,
                        x2,
                        x3)),
                    maxy = Math.ceil(Math.max(y0,
                        y1,
                        y2,
                        y3));
            ...
            isAt: function (x, y) {
                if (this.mapArea) {
                    return this.mapArea.containsPoint(x,
                        y);
                } else if (this.map) {
                    return this.map.containsPoint(x,
                        y);
                }
            ...
            _attr: function (name, value) {
                ...
                if (name === '_rotation') {
                    ...
                    this._globalZ = parseInt(value + Crafty.zeroFill(this[0],
                            5),
                        10); //magic number 10e5 is the max num of entities
    ...
    Crafty.polygon = function (poly) {
        if (arguments.length > 1) {
            poly = Array.prototype.slice.call(arguments,
                0);
        }
        this.points = poly;
    };
	...
	* }]
            ...
            hit: function (comp) {
                var area = this._mbr || this,
                    results = Crafty.map.search(area,
                        false),
    ...
    Crafty.c("WiredHitBox",
        {
            ...
            init: function () {
                ...
                if (Crafty.support.canvas) {
                    ...
                    this.requires("Collision").bind("EnterFrame",
                        function () {
                            if (drawed == total) {
                                ctx.clearRect(0,
                                    0,
                            ...
                            for (var p in this.map.points) {
                                ctx.lineTo(Crafty.viewport.x + this.map.points[p][0],
                                    Crafty.viewport.y + this.map.points[p][1]);
                            }
                            ctx.closePath();
                            ctx.stroke();
                            drawed++;
    ...
    Crafty.c("DOM",
        {
            ...
            init: function () {
                ...
                this.bind("NewComponent",
                    updateClass).bind("RemoveComponent",
                    updateClass);
            ...
            css: function (obj, value) {
                ...
                if (typeof obj === "object") {
                    ...
                    if (value) {
                        ...
                        return Crafty.DOM.getStyle(elem,
                            obj);
                    }
                }
        ...
        DOM: {
            ...
            inner: function (obj) {
                var rect = obj.getBoundingClientRect(),
                    ...
                    //border left
                    borderX = parseInt(this.getStyle(obj,
                                'border-left-width') || 0,
                            10) || parseInt(this.getStyle(obj,
                                'borderLeftWidth') || 0,
                            10) || 0,
                    borderY = parseInt(this.getStyle(obj,
                                'border-top-width') || 0,
                            10) || parseInt(this.getStyle(obj,
                                'borderTopWidth') || 0,
                            10) || 0;
            ...
            getStyle: function (obj, prop) {
                ...
                if (obj.currentStyle) {
                    ...
                    result = document.defaultView.getComputedStyle(obj,
                        null).getPropertyValue(this.csselize(prop));
                }
                return result;
            },
            ...
            xhr.onreadystatechange = function (evt) {
                if (xhr.readyState == 4) {
                    if (xhr.status == 200) {
                        ...
                        for (var i in data) {
                            if (Crafty.storage.check(data[i].key,
                                    data[i].timestamp)) {
        ...
        if (typeof indexedDB == 'object') {
            ...
            return {
                open: function (gameName_n) {
                    ...
                    if (arguments.length == 1) {
                        db = {
                            save: openDatabase(gameName_n + '_save',
                                '1.0',
                                'Saves games for ' + gameName_n,
                                5 * 1024 * 1024),
                            cache: openDatabase(gameName_n + '_cache',
                                '1.0',
                        ...
                        for (; i < args.length; i++) {
                            if (typeof db[args[i]] == 'undefined') {
                                db[args[i]] = openDatabase(gameName + '_' + args[i],
                                    '1.0',
                                    type,
                                    5 * 1024 * 1024);
                            }
                    ...
                    db['save'].transaction(function (tx) {
                        tx.executeSql('SELECT key, timestamp FROM data',
                            [],
                            function (tx, res) {
                ...
                save: function (key, type, data) {
                    ...
                    db[type].transaction(function (tx) {
                        ...
                        tx.executeSql('SELECT * FROM data WHERE key = ?',
                            [key],
                            function (tx, results) {
                                if (results.rows.length) {
                                    tx.executeSql('UPDATE data SET text = ?, timestamp = ? WHERE key = ?',
                                        [str, t, key]);
                                }
                                else {
                ...
                load: function (key, type, callback) {
                    ...
                    db[type].transaction(function (tx) {
                        tx.executeSql('SELECT text FROM data WHERE key = ?',
                            [key],
                            function (tx, results) {
                                if (results.rows.length) {
                ...
                getAllKeys: function (type, callback) {
                    ...
                    db[type].transaction(function (tx) {
                        tx.executeSql('SELECT key FROM data',
                            [],
                            function (tx, results) {
            ...
            return {
                ...
                getAllKeys: function (type, callback) {
                    ...
                    var reg = new RegExp(gameName + '_[^_=]',
                        'g'),
    ...
    Crafty.extend({
        ...
        sprite: function (tile, tileh, url, map, paddingX, paddingY) {
            ...
            paddingX = parseInt(paddingX || 0,
                10); //just incase
            paddingY = parseInt(paddingY || 0,
                10);
        ...
        viewport: {
            ...
            centerOn: function (targ, time) {
                ...
                Crafty.viewport.pan('reset');
                Crafty.viewport.pan('x',
                    new_x,
                    time);
                Crafty.viewport.pan('y',
                    new_y,
                    time);
            },
            /**@
                ...
                function enterFrame() {
                    if (dur > 0) {
                        ...
                        if (Crafty.canvas._canvas) {
                            Crafty.canvas.context.scale(zoom,
                                zoom);
                            Crafty.DrawManager.drawAll();
                        }
            ...
            scale: (function () {
                ...
                return function (amt) {
                    ...
                    if (Crafty.canvas._canvas) {
                        ...
                        Crafty.canvas.context.scale(this._zoom,
                            this._zoom);
                        Crafty.DrawManager.drawAll();
                    }
            ...
            init: function (w, h) {
                ...
                Crafty.settings.register("stageSelectable",
                    function (v) {
                ...
                Crafty.settings.modify("stageSelectable",
                    false);

                //make the stage have no context menu
                Crafty.settings.register("stageContextMenu",
                    function (v) {
                ...
                Crafty.settings.modify("stageContextMenu",
                    false);
    ...
    Crafty.c("Canvas",
        {
                ...
                this.bind("Change",
                    function (e) {
                        ...
                        if (this._changed === false) {
                            ...
                            if (e) {
                                this._changed = Crafty.DrawManager.add(e,
                                    this);
                            }
                        }
                    });
            ...
            draw: function (ctx, x, y, w, h) {
                ...
                if (this._mbr) {
                    ...
                    context.translate(this._origin.x + this._x,
	...
	* });
        ...
        mouseDispatch: function (e) {
            ...
            var maxz = -1,
                ...
                q,
                i = 0, l,
                pos = Crafty.DOM.translate(e.clientX,
                    e.clientY),
                x, y,
                dupes = {},
            ...
            if (!closest) {
                ...
                for (l = q.length; i < l; ++i) {
                    ...
                    if (current.mapArea) {
                        if (current.mapArea.containsPoint(x,
                                y)) {
                            flag = true;
                        }
                    } else if (current.isAt(x,
                            y)) {
                        flag = true;
                    }
            ...
            if (closest) {
                ...
                if (type === "mousedown") {
                    closest.trigger("MouseDown",
                        e);
                } else if (type === "mouseup") {
                    closest.trigger("MouseUp",
                        e);
                } else if (type == "dblclick") {
                    closest.trigger("DoubleClick",
                        e);
                } else if (type == "click") {
                    closest.trigger("Click",
                        e);
                } else if (type === "mousemove") {
                    closest.trigger("MouseMove",
                        e);
                    if (this.over !== closest) { //if new mousemove, it is over
                        if (this.over) {
                            this.over.trigger("MouseOut",
                                e); //if over wasn't null, send mouseout
                            this.over = null;
                        }
                        this.over = closest;
                ...
                if (type === "mousedown") {
                    ...
                    Crafty.viewport.mouselook('drag',
                        e);
                }
                else if (type == "mouseup") {
...
* })
    ...
    Crafty.c("Draggable",
        {
            ...
            init: function () {
                ...
                this._ondrag = function (e) {
                    var pos = Crafty.DOM.translate(e.clientX,
                        e.clientY);
                ...
                this._ondown = function (e) {
                    ...
                    //start drag
                    this._origMouseDOMPos = Crafty.DOM.translate(e.clientX,
                        e.clientY);
                    this._oldX = this._x;
                    this._oldY = this._y;
                    this._dragging = true;
	...
	* });
            ...
            animate: function (reelId, fromx, y, tox) {
                ...
                if (typeof fromx === "number") {
                    ...
                    tile = this.__tile + parseInt(this.__padding[0] || 0,
                            10);
                    tileh = this.__tileh + parseInt(this.__padding[1] || 0,
                            10);
    ...
    function tweenEnterFrame(e) {
        ...
        if (this.has('Mouse')) {
            ...
            if (over && over[0] == this[0] && !this.isAt(mouse.x,
                    mouse.y)) {
                this.trigger('MouseOut',
                    Crafty.lastEvent);
                Crafty.over = null;
            }
            else if ((!over || over[0] != this[0]) && this.isAt(mouse.x,
                    mouse.y)) {
                Crafty.over = this;
            ...
            image: function (url, repeat) {
                ...
                if (!this.img) {
                    ...
                    this.img.onload = function () {
                        if (self.has("Canvas")) {
                            self._pattern = Crafty.canvas.context.createPattern(self.img,
                                self._repeat);
                        }
                        self.ready = true;
                    ...
                    this.ready = true;
                    if (this.has("Canvas")) {
                        this._pattern = Crafty.canvas.context.createPattern(this.img,
                            this._repeat);
                    }
    ...
    Crafty.extend({
        ...
        toRGB: function (hex, alpha) {
            ...
            c[0] = parseInt(hex.substr(0,
                2),
                16);
            c[1] = parseInt(hex.substr(2,
                2),
                16);
            c[2] = parseInt(hex.substr(4,
                2),
                16);
        ...
        return {
                        ...
                        if (i < l - 1 && current._x < next._x + next._w && current._x + current._w > next._x &&
                            ...
                            merger = {
                                ...
                                _w: Math.max(current._x,
                                    next._x) + Math.max(current._w,
                                    next._w),
                                _h: Math.max(current._y,
                                    next._y) + Math.max(current._h,
                                    next._h)
                            };
            ...
            add: function add(old, current) {
                ...
                if (old === current) {
                    ...
                    rect = {
                        _x: ~~Math.min(before._x,
                            after._x),
                        _y: ~~Math.min(before._y,
                            after._y),
                        _w: Math.max(before._w,
                            after._w) + Math.max(before._x,
                            after._x),
                        _h: Math.max(before._h,
                            after._h) + Math.max(before._y,
                            after._y)
                    };
            ...
            draw: function draw() {
                ...
                for (i = 0; i < l; ++i) { //loop over every dirty rect
                    ...
                    q = Crafty.map.search(rect,
                        false); //search for ents under dirty rect
                ...
                for (i = 0, l = objs.length; i < l; ++i) {
                    ...
                    var area = ent._mbr || ent,
                        ...
                        w = ~~Math.min(area._w - x,
                            rect._w - (area._x - rect._x),
                            rect._w,
                            area._w),
                        h = ~~Math.min(area._h - y,
    ...
    Crafty.extend({
         ...
         * }
            ...
            area: function () {
                ...
                var start = this.px2pos(-center.left + Crafty.viewport.width / 2,
                    -center.top + Crafty.viewport.height / 2);
                var end = this.px2pos(-center.left - Crafty.viewport.width / 2,
                    -center.top - Crafty.viewport.height / 2);
                return {
                    x: {
                        start: start.x,
	...
	* }
            ...
            particles: function (options) {
                ...
                this._Particles.position = this._Particles.vectorHelpers.create(relativeX,
                    relativeY);
            ...
            _Particles: {
                ...
                init: function (options) {
                    this.position = this.vectorHelpers.create(0,
                        0);
                    ...
                    this.positionRandom = this.vectorHelpers.create(this.spread,
                        this.spread);
                },
                ...
                initParticle: function (particle) {
                    ...
                    var vector = this.vectorHelpers.create(Math.sin(newAngle),
                        -Math.cos(newAngle)); // Could move to lookup for speed
                    var vectorSpeed = this.speed + this.speedRandom * this.RANDM1TO1();
                    particle.direction = this.vectorHelpers.multiply(vector,
                        vectorSpeed);
                ...
                update: function () {
                    ...
                    while (this.particleIndex < this.particleCount) {
                        ...
                        if (currentParticle.timeToLive > 0) {
                            ...
                            currentParticle.direction = this.vectorHelpers.add(currentParticle.direction,
                                this.gravity);
                            currentParticle.position = this.vectorHelpers.add(currentParticle.position,
                ...
                render: function (context) {
                    ...
                    for (var i = 0, j = this.particleCount; i < j; i++) {
                        ...
                        if (this.fastMode) {
                            ...
                            var radgrad = context.createRadialGradient(x + halfSize,
                                y + halfSize,
                                particle.sizeSmall,
                                x + halfSize,
                                y + halfSize,
                                halfSize);
                            radgrad.addColorStop(0,
                                particle.drawColour);
                            //0.9 to avoid visible boxing
                            radgrad.addColorStop(0.9,
                ...
                particle: function (vectorHelpers) {
                    this.position = vectorHelpers.create(0,
                        0);
                    this.direction = vectorHelpers.create(0,
                        0);
                    this.size = 0;
                    this.sizeSmall = 0;
                    this.timeToLive = 0;
    ...
    Crafty.c("Text",
        {
            ...
            textColor: function (color, strength) {
                this._strength = strength;
                this._textColor = Crafty.toRGB(color,
                    this._strength);
                this.trigger("Change");
                return this;
            },
            ...
            for (; i < l; ++i) {
                ...
                if (Crafty.support.audio && Crafty.audio.supported[ext]) {
                    ...
                    if (obj.addEventListener) {
                        obj.addEventListener('canplaythrough',
                            pro,
                            false);
                    }
	...
	*     });
    ...
    Crafty.math = {
        ...
        distance: function (x1, y1, x2, y2) {
            var squaredDistance = Crafty.math.squaredDistance(x1,
                y1,
                x2,
                y2);
    ...
    Crafty.math.Vector2D = (function () {
        ...
        Vector2D.prototype.angleBetween = function (vecRH) {
            return Math.atan2(this.x * vecRH.y - this.y * vecRH.x,
        ...
        Vector2D.prototype.angleTo = function (vecRH) {
            return Math.atan2(vecRH.y - this.y,
                vecRH.x - this.x);
        };
        ...
        Vector2D.prototype.getNormal = function (vecRH) {
            if (vecRH === undefined) {
                return new Vector2D(-this.y,
                    this.x);
            } // assume vecRH is <0, 0>
            return new Vector2D(vecRH.y - this.y,
                this.x - vecRH.x).normalize();
        } // getNormal( )
        ...
        Vector2D.tripleProduct = function (a, b, c) {
            ...
            return new Crafty.math.Vector2D(b.x * ac - a.x * bc,
                b.y * ac - a.y * bc);
        };
