...
var player_coords = new Array([pixel_unit + (pixel_unit - bomberman_pixel_unit) / 2, pixel_unit + (pixel_unit - bomberman_pixel_unit) / 2], [pixel_unit * (dimension_x * 2 - 1) + (pixel_unit - bomberman_pixel_unit) / 2, pixel_unit * (dimension_y * 2 - 1) + (pixel_unit - bomberman_pixel_unit) / 2], [pixel_unit * (dimension_x * 2 - 1) + (pixel_unit - bomberman_pixel_unit) / 2, pixel_unit + (pixel_unit - bomberman_pixel_unit) / 2], [pixel_unit + (pixel_unit - bomberman_pixel_unit) / 2, pixel_unit * (dimension_y * 2 - 1) + (pixel_unit - bomberman_pixel_unit) / 2]);
